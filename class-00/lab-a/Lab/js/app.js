...
// rando is undefined when outside of the block that "let" defines it in on line 33, let only defines variables WITHIN the block statment.
  console.log(viewed);
  for (let i = 0; i < 3; i++){
...
//( code assist in massive part with kevin McNeil)